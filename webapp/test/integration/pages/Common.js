sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("MySecondProject/MySecondProject/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("MySecondProject.MySecondProject.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["MySecondProject/MySecondProject/localService/mockserver"], function (mockserver) {
