sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("MySecondProject.MySecondProject.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias MySecondProject.MySecondProject.controller.ListSelector
			 */
			 ...
			 * @return {MySecondProject.MySecondProject.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
